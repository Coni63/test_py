...
class DependencyListener(PlSqlParserListener):
    ...
    def enterCreate_procedure_body(self, ctx):
        ...
        print(f"Entering procedure body: {self.current_procedure}")
    ...
    def enterFunction_name(self, ctx):
        ...
        if self.current_procedure:
            print(f"Function '{function_name}' called inside procedure '{self.current_procedure}'")
            # Add the function to the list of functions called within the current procedure
            self.procedure_calls[self.current_procedure].append(function_name)
    ...
    def enterRoutine_name(self, ctx):
        ...
        if self.current_procedure:
            ...
            self.procedure_calls[self.current_procedure].append(call_text)
        else:
            print(ctx.getText())
